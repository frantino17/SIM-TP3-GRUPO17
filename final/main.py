...
def simular(self):
    ...
    # Obtener valores de los QDoubleSpinBox
    ...
    print(mensaje)  # Para depuración, puedes eliminarlo si no es necesario
...
def simular_semana(t1, t2, t3, t4, a1, a2, a3, a4, i):
    ...
    resultado = [i,
        [rnd_ventas_v1, ventas_v1, rnd_ventas_v2, ventas_v2, rnd_ventas_v3, ventas_v3, rnd_ventas_v4, ventas_v4]]
...
def mostrar_rango(inicial, numero_filas, resultado):
    filas = resultado[inicial:inicial + numero_filas]
